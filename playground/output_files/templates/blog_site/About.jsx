...
export default function Blog_SiteAboutPage() {
  ...
  <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <p>I'm a software developer with 6 years of experience building web applications. I believe in writing clean code, continuous learning, and helping others grow in their development journey.</p>
      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 text-left">Header</h1>
      <p>Started as a self-taught developer in 2018, worked at several startups, and now I'm a senior developer at a tech company. This blog is where I share what I've learned along the way.</p>
