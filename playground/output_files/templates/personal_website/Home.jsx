...
export default function Personal_WebsiteHomePage() {
  ...
  <div className="max-w-4xl mx-auto px-4 text-center">
    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Stop overspending on tokens now</h2>
    <p className="text-xl text-gray-600 mb-4">Our agents are ready to go</p>
