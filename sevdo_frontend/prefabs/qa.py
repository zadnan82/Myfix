...
def render_prefab(args, props):
    ...
    # Default Q&A data (only used when no DSL content)
    default_qa_data = [
        {
    ...
    # If DSL content was parsed but no Q&A pairs found, show just title
    if has_dsl_content and not qa_pairs:
  ...
  <div className="max-w-3xl mx-auto px-4">
    ...
    # Use parsed Q&A pairs or default data
    qa_data = qa_pairs if qa_pairs else default_qa_data
