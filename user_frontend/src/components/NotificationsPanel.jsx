...
const NotificationsPanel = ({ className = '' }) => {
  ...
  // Load notifications on mount with proper authentication check
  useEffect(() => {
  ...
  const setupWebSocketConnection = () => {
    try {
      const connection = websocketService.connectToNotifications(
        (message) => {
      ...
      if (!connection) {
        console.warn('WebSocket connection failed - notifications may not work in real-time');
      }
    } catch (error) {
