...
import { ArrowLeft, Plus, Code, Zap, Check, X, Star } from 'lucide-react';
import Button from '../../components/ui/Button';
import Input from '../../components/ui/Input';
import Card from '../../components/ui/Card';
import { TOKEN_MAPPINGS } from '../../utils/mockData';

const CreateProjectPage = ({ onBack, navigate }) => {
...
<Button
  onClick={() => navigate ? navigate('/templates') : window.location.href = '/templates'}
  variant="outline" 
