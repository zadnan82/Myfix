...
const DashboardPage = ({ onLogout, onNavigateLivePreview, onNavigateTemplateBrowser }) => { // UPDATED: Added props
  ...
  const handleNavigate = (path) => {
    ...
    } else if (onNavigateTemplateBrowser && path === '/templates') {
      // If this is template browser navigation
      onNavigateTemplateBrowser();
    } else {
